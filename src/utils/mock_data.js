...
export const WEDDING_DATA = {
    ...
    location: {
        name: "TƯ GIA NHÀ CHÚ RỂ",
        address: "Thôn 7 - Xã Eariêng - Tỉnh Đắk Lắk",
        mapLink: "https://www.google.com/maps?q=12.746445,108.811577"
    },
    
    bankInfo: {
        bankName: "Ngân hàng MB",
        accountNumber: "689199877777 ",
    ...
    // Ảnh nền phía sau (ảnh biển)
    mainPhoto: "/assets/couple/3.jpg",
    cutoutPhoto: "/assets/couple/1.png", 
    bottomQuotes: [
        "Anh mong những năm tháng sau này. Dù khó khăn hay hạnh phúc, già đi hay trẻ mãi. Em vẫn sẽ luôn bên anh và yêu như ngày đầu tiên.",
    ]
  },
